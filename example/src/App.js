...
export function TestComponent() {
    ...
    return (_jsxs(View, { style: styles.container, children: [_jsx(Button, { title: "Show Text Input Modal (Number)", onPress: async () => {
                    const value = await getTextInput({
                        title: 'Enter any value',
                        placeholder: 'Enter any value',
                    });
                    setResult(Number(value));
                } }), _jsxs(Text, { children: ["Result: ", result] }), _jsx(Button, { title: "Show Select Modal", onPress: async () => {
                    ...
                    setResult2(value);
                } }), _jsxs(Text, { children: ["Result: ", result2] }), _jsx(Button, { title: "Show Pick Modal", onPress: async () => {
